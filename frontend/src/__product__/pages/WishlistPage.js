...
} from "__product__/redux/actions/wishlistActions"
                      ...
                      <table>
                        ...
                        <tbody>
                          {wishlistItems.map((wishlistItem, key) => {
                            const finalProductPrice = wishlistItem.prdPrice * currency.currencyRate
                              ...
                              <tr key={key}>
                                <td className="product-thumbnail">
                                  ...
                                  >
                                    <img
                                      className="img-fluid"
                                      src={process.env.PUBLIC_URL + wishlistItem.prdImg}
                                      alt=""
                                    />
                                  </Link>
                                </td>
                                ...
                                <td className="product-wishlist-cart">
                                  {wishlistItem.prdInv && wishlistItem.prdInv > 0 ? (
                                    <button
                                ...
                                <td className="product-remove">
                                  <button
                                    onClick={() => deleteFromWishlist(wishlistItem, addToast)}
                                  >
                  ...
                  <div className="col-lg-12">
                    <div className="cart-shiping-update-wrapper">
                      <div className="cart-shiping-update">
                        <Link to={process.env.PUBLIC_URL + "/product/all"}>Continue Shopping</Link>
                      </div>
                ...
                <div className="col-lg-12">
                  <div className="item-empty-area text-center">
                    ...
                    <div className="item-empty-area__text">
                      ...
                      <Link to={process.env.PUBLIC_URL + "/product/all"}>Add Items</Link>
                    </div>
                  </div>
                </div>
              </div>
