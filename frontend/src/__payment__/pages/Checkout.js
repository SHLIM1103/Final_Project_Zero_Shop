                          ...
                          <div className="col-lg-6 col-md-6">
                            <div className="billing-info mb-20">
                              ...
                              <input
                                ...
                                name="rcvPhone"
                                value={rcvPhone}
                                placeholder="받으시는 분의 연락처를 입력하세요"
                                required
                                onChange={e => {
                                  setRcvPhone(`${e.target.value}`)
                                }}
                              />
                            </div>
                          </div>
                    ...
                    <div className="col-lg-5">
                      <div className="your-order-area">
                              ...
                              <ul>
                                ...
                                <li>
                                  ...
                                  <input
                                    type="hidden"
                                    name="shipping"
                                    value={cartTotalPrice < 50000 ? "￦2,500" : "무료배송"}
                                    readOnly
                                  />
                                </li>
                              </ul>
                              ...
                              <ul>
                                ...
                                <li>
                                  ...
                                  <input
                                    ...
                                    value={
                                      cartTotalPrice < 50000
                                        ? currency.currencySymbol + (cartTotalPrice + 2500)
                                        : currency.currencySymbol +
                                          cartTotalPrice
                                            .toString()
                                            .replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                        ...
                        <div className="place-order mt-25">
                          <button className="btn-hover" type="submit" onClick={placeOrder}>
                            결제하기
                          </button>
                        </div>
                      </div>
