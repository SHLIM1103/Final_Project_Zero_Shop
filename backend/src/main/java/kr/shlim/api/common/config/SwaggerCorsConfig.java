package kr.shlim.api.common.config;
...
public class SwaggerCorsConfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder()//
                ...
                .description("This is a sample JWT authentication service. You can find out more about JWT at [https://jwt.io/](https://jwt.io/). " +
